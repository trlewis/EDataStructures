namespace EDataStructuresTests
{
    ...
    /// <summary>
    /// Summary description for MinHeapTests
    /// </summary>
    [TestClass]
    public class MinHeapTests
    {
        ...
        public void InitializeOnly()
        {
            ...
            var heap = new MinHeap<int>(intList);
        ...
        public void InitializeGroupRemoveSomeAddGroup()
        {
            ...
            var heap = new MinHeap<int>(intList);
            heap.RemoveRoot();
            heap.RemoveRoot(); //only (3, 8) should remain

            var extraInts = new List<int> { 1, 3, 5 };
            heap.AddMany(extraInts); // (1, 3, 3, 5, 8)
        ...
        public void PeekInitializeGroup()
        {
            ...
            var heap = new MinHeap<int>(intList);
            Assert.AreEqual(heap.PeekRoot(), 2);
            Assert.AreEqual(heap.PeekRoot(), 2);
        }
        ...
        public void PeekInitializeEmptyAddGroup()
        {
            ...
            heap.AddMany(intList);
            Assert.AreEqual(heap.PeekRoot(), -10);
            Assert.AreEqual(heap.PeekRoot(), -10);
        }
